...
if($sql)
                    {
                        echo '<script>alert("Data Added Successfully");window.location="pro4view.php"</script>';
                    }
                    else
                    {
    ...
    echo '<script>alert("Passport Number Already Present");window.location="pro4add.php"</script>';
}
}
?>
</body>
