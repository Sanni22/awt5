...
include 'con_db.php';
    if($_POST)
    {
        ...
        if($row==0){
            echo '<script>alert("Passport Number not found");window.location="pro4update.php"</script>';
        }
    }
?>
...
if($sql)
                    {
                        echo '<script>alert("Data Updated Successfully");window.location="pro4view.php"</script>';
                    }
                    else
                    {
