...
if($_POST)
    {
        ...
        if($row==0){
            echo '<script>alert("Enter the valid account Number ");window.location="pro5withdraw.php"</script>';
        }
...
<body style="background-color: black;color: yellow;">
    <center>
        <form method="post" action="pro5depo.php">
    <table border="1" style="text-align:left;">
        ...
        <tr>
            <th colspan="3" style="text-align:center"><a href="pro5.php" class="btn btn-dark">Back</a></th>
        </tr> 
    </table>
</form>
    </center>
